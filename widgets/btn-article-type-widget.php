...
class BTN_Article_Type_Widget extends \Elementor\Widget_Base{

	public static $slug = 'elementor-btn-article-type';
	...
	public function get_title() {
		return __('Article Type Category', 'btn-articles');
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => __( 'Article Type', 'btn-articles' ),
	...
	protected function render() {
		...
		$css_class = "btn-category-default btn-type-default";
		if ( 'yes' === $settings['show_description'] ) {
				$css_class = "btn-category-description";
		}
		$html .= '<ul class="'.$css_class.'">';
		$catlist = get_terms(btn_articles()->articles()->get_taxonomy_type_slug(),$tax_args);
		if ( ! empty( $catlist ) ) {
