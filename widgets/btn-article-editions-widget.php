...
class BTN_Article_Editions_Widget extends \Elementor\Widget_Base{

	public static $slug = 'elementor-btn-article-editions';
	...
	public function get_title() {
		return __('Article Editions', 'btn-articles');
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => __( 'Article Editions', 'btn-articles' ),
	...
	protected function render() {
		...
		$catlist = get_terms(btn_articles()->articles()->get_taxonomy_edition_slug(),$tax_args);
		if ( ! empty( $catlist ) ) {
